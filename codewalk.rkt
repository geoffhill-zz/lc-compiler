...
(slide
 ...
 (hc-append 30.0
            ...
            (scale
             (vl-append
              80.0
              (code (define/contract (build-l2fn-base lstform)
                      (-> list? l2fn-base?)
                      ...))
              (code (define/contract (build-l2fn-succ l2fn)
                      (-> l2fn-base? l2fn-succ?)
                      ...))
              (code (define/contract (build-l2fn-liveness l2fn)
                      (-> l2fn-succ? l2fn-liveness?)
                      ...))
              (code (define/contract (build-l2fn-graph l2fn)
                      (-> l2fn-liveness? l2fn-graph?)
                      ...))
              (code (define/contract (build-l2fn-color l2fn)
                      (-> l2fn-graph? l2fn-color?)
                      ...))
              (code (define/contract (compile-stmts stmts)
