...
(test (inline (build-L5expr '(letrec ([g (lambda (f) (+ f f))]) 3)))
      (build-L5expr '(letrec ([g (lambda (f) (+ f f))]) 3)))
(test (inline (build-L5expr '(letrec ([g (lambda (f) (+ f f))]) (g 12))))
      (build-L5expr '(letrec ([g (lambda (f) (+ f f))])
                       (let ([f 12]) (+ f f)))))
...
(test (optimize (build-L5expr '(letrec ([g (lambda (f) (+ f f))]) (g 12))))
      (build-L5expr '(letrec ([g (lambda (f) (+ f f))]) 24)))
...
(test (compile-L5expr-unoptim (build-L5expr '5))
      (build-L4prog '(5)))
(test (compile-L5expr-unoptim (build-L5expr '(+ 4 5)))
      (build-L4prog '((+ 4 5))))
(test (compile-L5expr-unoptim (build-L5expr '(let ([x 4]) x)))
      (build-L4prog '((let ([v0 4]) v0))))
(test (compile-L5expr-unoptim (build-L5expr '(lambda () 4)))
      (build-L4prog '((make-closure :l5clj_0 0)
                      (:l5clj_0 (frees) 4))))
(test (compile-L5expr-unoptim (build-L5expr '(let ([x (lambda () 4)]) 5)))
      (build-L4prog '((let ([v0 (make-closure :l5clj_0 0)]) 5)
                      (:l5clj_0 (frees) 4))))
(test (compile-L5expr-unoptim (build-L5expr '(let ([x (lambda () 4)]) (x))))
      (build-L4prog '((let ([v0 (make-closure :l5clj_0 0)])
                        ((closure-proc v0) (closure-vars v0)))
                      (:l5clj_0 (frees) 4))))
(test (compile-L5expr-unoptim (build-L5expr '(let ([x (lambda (t) (t 4 5))]) (x z))))
      (build-L4prog '((let ([v1 (make-closure :l5clj_0 0)])
                        ((closure-proc v1) (closure-vars v1) v2))
                      (:l5clj_0 (frees v0)
                                ((closure-proc v0) (closure-vars v0) 4 5)))))
(test (compile-L5expr-unoptim (build-L5expr '(let ([x (lambda (t) (t 4 5))]) (print (x +)))))
      (build-L4prog '((let ([v1 (make-closure :l5clj_0 0)])
...
(test (compile-L5expr-unoptim (build-L5expr '(letrec ([x 6]) (print x))))
