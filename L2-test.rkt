...
(test (fix-stack `#(,(stmt-assign 't 5) ,(stmt-assign 'eax 't)) 0)
      `#(,(stmt-assign 't 5)
         ,(stmt-assign 'eax 't)))
(test (fix-stack `#(,(stmt-assign 't 5) ,(stmt-assign 'eax 't)) -4)
      `#(,(stmt-aop 'esp '-= 4)
         ,(stmt-assign 't 5)
         ,(stmt-assign 'eax 't)
         ,(stmt-aop 'esp '+= 4)))
(test (fix-stack `#(,(stmt-assign 't 5) ,(stmt-assign 'eax 't)) -32)
      `#(,(stmt-aop 'esp '-= 32)
         ,(stmt-assign 't 5)
         ,(stmt-assign 'eax 't)
         ,(stmt-aop 'esp '+= 32)))
(test (fix-stack `#(,(stmt-label ':fn1) ,(stmt-assign 'g 2) ,(stmt-assign 'eax 'g)) 0)
      `#(,(stmt-label ':fn1)
         ,(stmt-assign 'g 2)
         ,(stmt-assign 'eax 'g)))
(test (fix-stack `#(,(stmt-label ':fn1) ,(stmt-assign 'g 2) ,(stmt-assign 'eax 'g)) -4)
      `#(,(stmt-label ':fn1)
         ,(stmt-aop 'esp '-= 4)
         ,(stmt-assign 'g 2)
         ,(stmt-assign 'eax 'g)
         ,(stmt-aop 'esp '+= 4)))
(test (fix-stack `#(,(stmt-label ':fn1) ,(stmt-assign 'g 2) ,(stmt-assign 'eax 'g)) -32)
      `#(,(stmt-label ':fn1)
         ,(stmt-aop 'esp '-= 32)
         ,(stmt-assign 'g 2)
         ,(stmt-assign 'eax 'g)
