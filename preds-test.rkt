...
(test/pred (L3-x? 'r1) (not/c false?))
(test/pred (L3-x? 'temp0) (not/c false?))
(test/pred (L3-x? 'var) (not/c false?))
(test/pred (L3-x? 'eax) (not/c false?))
(test/pred (L3-x? 'edi) (not/c false?))
(test/pred (L3-x? ':label) false?)
(test/pred (L3-x? '5) false?)
(test/pred (L3-x? '+) false?)
(test/pred (L3-x? 'a?) false?)
(test/pred (L3-x? 'number?) false?)

(test/pred (L3-keyword? 'let) (not/c false?))
(test/pred (L3-keyword? 'if) (not/c false?))
(test/pred (L3-keyword? 'new-array) (not/c false?))
(test/pred (L3-keyword? 'new-tuple) (not/c false?))
(test/pred (L3-keyword? 'aref) (not/c false?))
(test/pred (L3-keyword? 'aset) (not/c false?))
(test/pred (L3-keyword? 'alen) (not/c false?))
(test/pred (L3-keyword? 'print) (not/c false?))
(test/pred (L3-keyword? 'make-closure) (not/c false?))
(test/pred (L3-keyword? 'closure-proc) (not/c false?))
(test/pred (L3-keyword? 'closure-vars) (not/c false?))
(test/pred (L3-keyword? 'a) false?)
(test/pred (L3-keyword? ':label) false?)
(test/pred (L3-keyword? '5) false?)
(test/pred (L3-keyword? '+) false?)
(test/pred (L3-keyword? 'a?) false?)
(test/pred (L3-keyword? 'number?) false?)

(test/pred (L3-biop? '+) (not/c false?))
(test/pred (L3-biop? '-) (not/c false?))
(test/pred (L3-biop? '*) (not/c false?))
(test/pred (L3-biop? '<) (not/c false?))
(test/pred (L3-biop? '<=) (not/c false?))
(test/pred (L3-biop? '=) (not/c false?))
(test/pred (L3-biop? '+=) false?)
(test/pred (L3-biop? '<<=) false?)
(test/pred (L3-biop? 5) false?)
(test/pred (L3-biop? ':label) false?)

(test/pred (L3-pred? 'number?) (not/c false?))
(test/pred (L3-pred? 'a?) (not/c false?))
(test/pred (L3-pred? 'umber?) false?)
(test/pred (L3-pred? 'a) false?)
(test/pred (L3-pred? '<=) false?)
(test/pred (L3-pred? '+=) false?)
(test/pred (L3-pred? '<<=) false?)
